...
func TestParsePath(t *testing.T) {
	tcs := []struct {
		...
		{"/myorg/myproj/myrepo/sub1", parts{org: "myorg", proj: "myproj", repo: "myrepo"}},
		{"/myorg/myproj/myrepo/sub1/", parts{org: "myorg", proj: "myproj", repo: "myrepo"}},
		{"/myorg/myproj/myrepo.git", parts{org: "myorg", proj: "myproj", repo: "myrepo.git"}},
		{"/myorg/myproj/myrepo.git/sub1", parts{org: "myorg", proj: "myproj", repo: "myrepo.git"}},
		{"/myorg/myproj/myrepo/sub1/sub2", parts{org: "myorg", proj: "myproj", repo: "myrepo"}},
	}
	for _, tc := range tcs {
